...
public final class FileConfigurationParser extends XMLConfigurationUtil {
   ...
   private static final String MAX_HIERARCHICAL_SIZE_MESSAGES_NODE_NAME = "max-hierarchical-size-messages";

   private static final String MAX_HIERARCHICAL_SIZE_BYTES_NODE_NAME = "max-hierarchical-size-bytes";
   ...
   protected Pair<String, AddressSettings> parseAddressSettings(final Node node) {
      ...
      for (int i = 0; i < children.getLength(); i++) {
         ...
         } else if (MAX_HIERARCHICAL_SIZE_MESSAGES_NODE_NAME.equalsIgnoreCase(name)) {
            addressSettings.setMaxHierarchicalSizeMessages(MINUS_ONE_OR_GT_ZERO.validate(MAX_HIERARCHICAL_SIZE_MESSAGES_NODE_NAME, XMLUtil.parseLong(child)).longValue());
         } else if (MAX_HIERARCHICAL_SIZE_BYTES_NODE_NAME.equalsIgnoreCase(name)) {
            addressSettings.setMaxHierarchicalSizeBytes(MINUS_ONE_OR_GT_ZERO.validate(MAX_HIERARCHICAL_SIZE_BYTES_NODE_NAME, ByteUtil.convertTextBytes(getTrimmedTextContent(child))).longValue());
